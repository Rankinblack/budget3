...
const __TWEAKS_STYLE = `
  ...
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483646;width:46px;height:46px;
    border:0;border-radius:50%;cursor:pointer;display:flex;align-items:center;justify-content:center;
    background:rgba(14,73,64,.95);color:#F6F2EA;
    box-shadow:0 6px 20px rgba(0,0,0,.25),0 1px 0 rgba(255,255,255,.15) inset;
    -webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);transition:transform .15s,box-shadow .15s}
  .twk-fab:hover{transform:translateY(-1px);box-shadow:0 10px 26px rgba(0,0,0,.3)}
  .twk-fab:active{transform:translateY(0)}
  .twk-fab svg{width:22px;height:22px}
`;
...
function TweaksPanel({
  ...
  const PAD = 16;
  // Standalone (not embedded in the Claude editing host): no parent frame to
  // drive edit-mode, so surface our own floating button to open the panel.
  ...
  const dismiss = () => {
    setOpen(false);
    if (!standalone) window.parent.postMessage({
  ...
  if (!open) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, __TWEAKS_STYLE), /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "twk-fab",
      "aria-label": "\u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0648\u0627\u0644\u0645\u0638\u0647\u0631",
